...
export declare class EmployeeProfileService {
    ...
    updateBankingInfo(id: string, bankingData: {
        bankName?: string;
        bankAccountNumber?: string;
    }): Promise<EmployeeProfile>;
    updateBiography(id: string, biography: string): Promise<EmployeeProfile>;
    uploadProfilePhoto(id: string, photo: Express.Multer.File): Promise<string>;
    ...
    updateSystemRoles(employeeId: string, roles?: SystemRole[], permissions?: string[]): Promise<EmployeeSystemRole>;
    deactivateSystemRoles(employeeId: string): Promise<void>;
    createCandidate(createCandidateDto: CreateCandidateDto): Promise<Candidate>;
    findAllCandidates(): Promise<Candidate[]>;
    findAllCandidatesWithFilters(query: any): Promise<Candidate[]>;
    ...
    getAllProfileChangeRequestsWithFilters(query: any): Promise<EmployeeProfileChangeRequest[]>;
    ...
    cancelProfileChangeRequest(id: string, employeeId: string): Promise<EmployeeProfileChangeRequest>;
    ...
    updateQualification(qualificationId: string, employeeId: string, qualificationData: {
        establishmentName?: string;
        graduationType?: string;
    }): Promise<EmployeeQualification>;
    removeQualification(qualificationId: string, employeeId: string): Promise<void>;
    advancedSearch(searchCriteria: any): Promise<any[]>;
    exportToExcel(query: QueryEmployeeDto): Promise<Buffer>;
    exportToPdf(employeeId: string): Promise<Buffer>;
    getTeamMembers(managerId: string): Promise<EmployeeProfile[]>;
    getTeamStatistics(managerId: string): Promise<any>;
    ...
    registerCandidate(registerDto: RegisterCandidateDto): Promise<Candidate>;
}
