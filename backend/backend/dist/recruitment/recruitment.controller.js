...
let RecruitmentController = class RecruitmentController {
    ...
    async uploadContractDocument(offerId, file, body) {
        const documentType = body?.documentType || document_type_enum_1.DocumentType.CONTRACT;
    ...
    async uploadCandidateForm(offerId, file, body) {
        const documentType = body?.documentType || document_type_enum_1.DocumentType.ID;
        const nationalId = body?.nationalId;
        const documentDescription = body?.documentDescription;
        const manualEntry = body?.manualEntry === true || body?.manualEntry === 'true';
        const manualDocumentData = manualEntry && !file ? {
    ...
    async createOnboarding(createOnboardingDto) {
        return this.service.createOnboarding(createOnboardingDto, undefined, undefined, undefined, createOnboardingDto.contractId);
    }
    ...
    async uploadTaskDocument(onboardingId, taskIndex, file, body) {
        const documentType = body?.documentType || document_type_enum_1.DocumentType.ID;
        const nationalId = body?.nationalId;
        const documentDescription = body?.documentDescription;
        const manualEntry = body?.manualEntry === true || body?.manualEntry === 'true';
        ...
        return this.service.uploadTaskDocument(onboardingId, parseInt(taskIndex, 10), file, documentType, manualDocumentData);
    }
...
__decorate([
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(employee_profile_enums_1.SystemRole.JOB_CANDIDATE, employee_profile_enums_1.SystemRole.HR_EMPLOYEE, employee_profile_enums_1.SystemRole.HR_MANAGER, employee_profile_enums_1.SystemRole.SYSTEM_ADMIN),
    (0, common_1.Post)('offer/:id/upload-contract'),
...
], RecruitmentController.prototype, "uploadContractDocument", null);
__decorate([
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(employee_profile_enums_1.SystemRole.JOB_CANDIDATE, employee_profile_enums_1.SystemRole.HR_EMPLOYEE, employee_profile_enums_1.SystemRole.HR_MANAGER, employee_profile_enums_1.SystemRole.SYSTEM_ADMIN),
    (0, common_1.Post)('offer/:id/upload-form'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', multer_config_1.multerConfig)),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.UploadedFile)()),
    __param(2, (0, common_1.Body)()),
    ...
    __metadata("design:paramtypes", [String, Object, Object]),
    __metadata("design:returntype", Promise)
], RecruitmentController.prototype, "uploadCandidateForm", null);
__decorate([
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(employee_profile_enums_1.SystemRole.HR_MANAGER, employee_profile_enums_1.SystemRole.SYSTEM_ADMIN),
