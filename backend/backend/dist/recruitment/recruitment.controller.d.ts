...
export declare class RecruitmentController {
    ...
    previewJob(id: string): Promise<{
        ...
        openings: number;
        location: string;
        hiringManagerId: import("mongoose").Types.ObjectId;
    ...
    uploadContractDocument(offerId: string, file: any, body: any): Promise<any>;
    uploadCandidateForm(offerId: string, file: any, body: any): Promise<any>;
    ...
    uploadTaskDocument(onboardingId: string, taskIndex: string, file: any, body: any): Promise<any>;
