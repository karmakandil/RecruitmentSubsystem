...
export declare class RecruitmentService {
    ...
    previewJobRequisition(id: string): Promise<{
        preview: boolean;
    ...
    getAllJobRequisitions(): Promise<any[]>;
    ...
    sendNotification(notificationType: 'application_status' | 'interview_scheduled' | 'offer_letter' | 'onboarding_welcome' | 'onboarding_reminder' | 'onboarding_completed' | 'panel_invitation' | 'clearance_reminder' | 'access_revoked', recipientEmail: string, context: any, options?: {
        nonBlocking?: boolean;
    }): Promise<void>;
    private sendEmailInternal;
    sendEmail(recipient: string, subject: string, text: string): Promise<void>;
    createOnboarding(createOnboardingDto: CreateOnboardingDto, contractSigningDate?: Date, startDate?: Date, workEmail?: string, contractId?: Types.ObjectId): Promise<any>;
    ...
    uploadTaskDocument(onboardingId: string, taskIndex: number, file: any, documentType: DocumentType, manualDocumentData?: {
        nationalId?: string;
    ...
    uploadContractDocument(offerId: string, file: any, documentType?: DocumentType, manualDocumentData?: {
        nationalId?: string;
        documentDescription?: string;
    }): Promise<any>;
    uploadCandidateForm(offerId: string, file: any, documentType: DocumentType, manualDocumentData?: {
        nationalId?: string;
        documentDescription?: string;
    }): Promise<any>;
