...
const DelegateApproval_dto_1 = require("./dto/DelegateApproval.dto");
...
let LeaveController = class LeaveController {
    ...
    async rejectLeaveRequest(id, rejectLeaveRequestDto, req) {
        return await this.leavesService.rejectLeaveRequest(rejectLeaveRequestDto, req.user.userId || req.user._id || req.user.id, id);
    }
    async finalizeLeaveRequest(finalizeDto, req) {
        return await this.leavesService.finalizeLeaveRequest(finalizeDto.leaveRequestId, req.user.userId || req.user._id || req.user.id);
    }
    ...
    async resetLeaveBalancesForNewYear(body) {
    ...
    async delegateApprovalAuthority(delegateDto, req) {
        return await this.leavesService.delegateApprovalAuthority(req.user.userId || req.user._id || req.user.id, delegateDto.delegateId, delegateDto.startDate, delegateDto.endDate);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [FinalizeLeaveRequest_dto_1.FinalizeLeaveRequestDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Post)('reset-leave-balances'),
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(employee_profile_enums_1.SystemRole.HR_MANAGER, employee_profile_enums_1.SystemRole.HR_ADMIN),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], LeaveController.prototype, "resetLeaveBalancesForNewYear", null);
__decorate([
    ...
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [DelegateApproval_dto_1.DelegateApprovalDto, Object]),
    __metadata("design:returntype", Promise)
], LeaveController.prototype, "delegateApprovalAuthority", null);
