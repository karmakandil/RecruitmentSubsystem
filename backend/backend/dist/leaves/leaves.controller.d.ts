...
export declare class LeaveController {
    ...
    finalizeLeaveRequest(finalizeDto: FinalizeLeaveRequestDto, req: any): Promise<import("mongoose").Document<unknown, {}, import("./models/leave-request.schema").LeaveRequest, {}, {}> & import("./models/leave-request.schema").LeaveRequest & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    }>;
    ...
    resetLeaveBalancesForNewYear(body: {
        criterion?: 'HIRE_DATE' | 'FIRST_VACATION_DATE' | 'REVISED_HIRE_DATE' | 'WORK_RECEIVING_DATE';
    }): Promise<{
        message: string;
    }>;
    delegateApprovalAuthority(delegateDto: DelegateApprovalDto, req: any): Promise<{
        message: string;
        delegation: any;
    }>;
}
