          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div className="space-y-2">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-2 drop-shadow-lg">Insurance Brackets</h1>
                  <p className="text-white/80 text-lg">Manage insurance contribution brackets</p>
                </div>
              </div>
            </div>
            {canCreateEdit && (
              <button
                ...
                className="group relative px-6 py-3 bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 text-white text-sm font-bold rounded-xl shadow-2xl hover:shadow-cyan-500/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 transition-all duration-300 flex items-center transform hover:scale-105 overflow-hidden"
              >
                ...
                <span className="relative z-10">Create New Insurance Bracket</span>
              </button>
            )}
          </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <select
                  ...
                  className="px-4 py-2 text-sm font-medium border-2 border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 bg-white/10 backdrop-blur-md text-white transition-all duration-200 hover:border-white/50"
