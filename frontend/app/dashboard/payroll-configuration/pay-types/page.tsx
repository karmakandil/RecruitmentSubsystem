      ...
      render: (item: any) => {
        ...
        return (
          <div className="space-y-1">
            ...
            <div className="text-xs text-white/70">Compensation amount</div>
          </div>
        );
      }
    },
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div className="space-y-2">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-2 drop-shadow-lg">Pay Types</h1>
                  <p className="text-white/80 text-lg">Define different types of compensation (salary, hourly, commission, etc.)</p>
                </div>
              </div>
            </div>
            {canCreateEdit && (
              <button
                ...
                className="group relative px-6 py-3 bg-gradient-to-r from-purple-600 via-pink-600 to-teal-600 text-white text-sm font-bold rounded-xl shadow-2xl hover:shadow-purple-500/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-300 flex items-center transform hover:scale-105 overflow-hidden"
              >
                ...
                <span className="relative z-10">Create New Pay Type</span>
              </button>
            )}
          </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <select
                  ...
                  className="px-4 py-2 text-sm font-medium border-2 border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white/10 backdrop-blur-md text-white transition-all duration-200 hover:border-white/50"
