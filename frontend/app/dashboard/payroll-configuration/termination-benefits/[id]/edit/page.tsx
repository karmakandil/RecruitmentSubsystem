      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="text-center">
            <div className="h-12 w-12 animate-spin rounded-full border-4 border-rose-300 border-t-transparent mx-auto mb-4"></div>
            <p className="text-white font-medium">Loading termination benefit...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <p className="text-white/80 text-lg">Update the termination benefit information</p>
            </div>
          </div>
        </div>
