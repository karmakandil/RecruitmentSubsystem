      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="text-center">
            <div className="h-12 w-12 animate-spin rounded-full border-4 border-violet-300 border-t-transparent mx-auto mb-4"></div>
            <p className="text-white font-medium">Loading policy...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <p className="text-white/80 text-lg">Update the policy information</p>
            </div>
          </div>
        </div>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 border-2 border-white/30 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 bg-white hover:border-white/50"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 border-2 border-white/30 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200 bg-white hover:border-white/50"
                    />
                  </div>
              ...
              {formData.policyType === 'overtime' && (
                <div className="border-b border-white/20 pb-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-white">Overtime Rules</h2>
                  </div>
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div className="space-y-2">
                      <label className="flex items-center gap-2 text-sm font-semibold text-white">
                      ...
                      <input
                        ...
                        step="0.1"
                        min="1"
                        className="w-full px-4 py-3 border-2 border-white/30 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 bg-white hover:border-white/50"
                      />
                      <p className="text-xs text-white/70 flex items-center gap-1">
                        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
