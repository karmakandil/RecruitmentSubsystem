    ...
    <ProtectedRoute>
      <div className="container mx-auto px-6 py-8">
        ...
        {isHR && (
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {/* CHANGED - REC-003: Job Templates - HR Manager and System Admin can create templates */}
              ...
              {(isHRManager || isHREmployee || isSystemAdmin) && (
                <Card>
                  <CardHeader>
              ...
              {/* CHANGED - Recruitment Progress for HR Manager and System Admin */}
              {(isHRManager || isSystemAdmin) && (
                <Card>
                  <CardHeader>
